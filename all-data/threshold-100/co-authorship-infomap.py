...
editor_profile = pd.read_csv('result/co-authorship.csv',encoding="utf-16",sep="\t")
...
all_data_sim.to_parquet('result/sim-matrix-based-on-co-authorship')
...
res.to_csv('result/cluster-param-test-by-co-authorship.csv',encoding='utf-16', sep="\t")